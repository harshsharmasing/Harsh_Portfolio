    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        @media (max-width:768px) {
          ...
          .tools-drag-hint { display:none !important; }
        }
        ...
        @media (max-width:768px) {
          ...
          .photo-wrap .hero-img {
            ...
            object-position:30% top !important;   /* 65% shows face, not arms */
      ...
      <div style={{ width:"100vw", minHeight:"100vh", background:"#000", color:"#fff",
        ...
        <section id="home" className="hero" style={{
          ...
          <div className="text-col">
            <div style={{ display:"flex", alignItems:"stretch" }}>
              ...
              <div style={{ display:"flex", flexDirection:"column", alignItems:"flex-start" }}>
                ...
                <a href={harshcv} download="HarshSharma_CV.pdf" className="cv-btn" style={{
                  ...
                  alignSelf:"flex-start", display:"inline-block", textDecoration:"none",
                }}>
                  Download Cv
                </a>
              </div>
          ...
          <div className="social-icons" style={{
            ...
            {[
              ...
              { icon:<InstagramIcon />,  href:"https://www.instagram.com/harshsharmasing?igsh=cXVtMXloNDdwamt2&utm_source=qr" },
            ].map(({ icon, href }) => (
          ...
          <div className="about-grid" style={{ display:"flex", alignItems:"flex-start" }}>
            ...
            <div className="about-txt-col" style={{
              ...
              <div style={{ display:"flex", gap:14, flexWrap:"wrap" }}>
                <a href={harshcv} download="HarshSharma_CV.pdf"
        ...
        <section id="tools" ref={toolsRef} className="tools-section" style={{
          ...
          {/* Scroll hint */}
          <div className="tools-drag-hint" style={{ display:"flex", alignItems:"center", gap:10, marginTop:28,
              ...
              <div key={num} className="proj-small" style={{
                ...
                <div style={{ padding:"20px 22px 24px" }}>
                  ...
                  <h3 style={{ fontSize:16, fontWeight:800, letterSpacing:-0.3,
                    marginBottom: desc ? 8 : 12, lineHeight:1.2 }}>{title}</h3>
                  {desc && (
                    <p style={{ fontSize:12, lineHeight:1.7, color:"rgba(255,255,255,0.4)",
                      marginBottom:10 }}>{desc}</p>
                  )}
                  ...
                  {/* Bottom links — matching proj 01 style */}
                  <div style={{ display:"flex", gap:12 }}>
                    <a href={live} target="_blank" rel="noreferrer" className="plink solid">
                      <svg width="13" height="13" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" strokeWidth="2.5">
                        <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>
                        <polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/>
                    ...
                    <a href={github} target="_blank" rel="noreferrer" className="plink outline">
                      <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/>
                      </svg>
                      GitHub
